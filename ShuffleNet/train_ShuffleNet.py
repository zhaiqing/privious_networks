...
from my_dataset_ShuffleNet import MyDataSet
from utils_ShuffleNet import read_split_data, train_one_epoch, evaluate
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default="E:/data_set/flower_data/flower_photos")
